...
public class TestButler {
    ...
    private static final String TAG = TestButler.class.getSimpleName() + "-MDC";
     ...
     */
    public static void setWifiState(boolean enabled) throws Throwable{
        verifyApiReady();
        try {
     ...
     */
    public static void setLocationMode(@LocationMode int locationMode) throws Throwable{
        verifyApiReady();
        try {
     ...
     */
    public static void setRotation(@Rotation int rotation)  throws Throwable{
        verifyApiReady();
        try {
     ...
     */
    public static void setImmersiveModeConfirmation(boolean enabled) throws Throwable{
        try {
