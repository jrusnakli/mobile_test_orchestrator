...
from testbutlerlive.application import Application


# noinspection PyShadowingNames
class TestApplication:

    def test_install_uninstall(self, adb, test_butler_app):  # noqa
        device = adb()
    ...
    def test_grant_permissions(self, adb, test_butler_test_app):  # noqa
        device = adb()
    ...
    def test_start_stop(self, adb, test_butler_app):  # noqa
        device = adb()
        app = Application.install(test_butler_app(), device)
        try:
    ...
    def test_monkey(self, adb, test_butler_app):  # noqa
        device = adb()
        app = Application.install(test_butler_app(), device)
        try:
            app.monkey()
    ...
    def test_clear_data(self, adb, test_butler_app):  # noqa
        device = adb()
        app = Application.install(test_butler_app(), device)
